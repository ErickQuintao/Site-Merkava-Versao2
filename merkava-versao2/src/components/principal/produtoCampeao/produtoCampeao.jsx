...
return(
    ...
    <p className="text-best-selling">
         Com um design inovador e construção
          robusta, nossa caixa de ferramentas
           sanfonada oferece espaço amplo para 
       organizar suas ferramentas de forma
       eficiente.<br/><br/> Seu mecanismo 
      sanfonado
        permite fácil acesso aos 
        compartimentos individuais,
     evitando bagunça e perda de tempo.<br/><br/>
  Construída com materiais de alta qualidade 
  e reforçada para resistir a condições exigentes,
